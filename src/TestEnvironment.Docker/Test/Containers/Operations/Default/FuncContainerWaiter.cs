...
namespace TestEnvironment.Docker.Test.Containers.Operations.Default
{
    public class FuncContainerWaiter : BaseContainerWaiter<Container>
    {
        ...
        protected override Task<bool> PerformCheck(Container container, CancellationToken cancellationToken) => _waitFunc(container);
    }
}
