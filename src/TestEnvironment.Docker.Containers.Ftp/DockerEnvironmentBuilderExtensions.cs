...
namespace TestEnvironment.Docker.Containers.Ftp
{
    ...
    {
        public static IDockerEnvironmentBuilder AddFtpContainer(this IDockerEnvironmentBuilder builder, string name, string ftpUserName,
            string ftpPassword, string imageName = "stilliard/pure-ftpd", string tag = "hardened", IDictionary<string, string> environmentVariables = null, IDictionary<ushort, ushort> ports = null, bool reuseContainer = false) =>
